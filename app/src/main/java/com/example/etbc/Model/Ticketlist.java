...
public class Ticketlist extends ArrayAdapter {
    private Activity context;
    private List<TicketBooked> ticketList;
    public Ticketlist(Activity context,  List<TicketBooked> ticketList){
        super(context, R.layout.list_item,ticketList);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        @SuppressLint("ViewHolder") View listViewItem=inflater.inflate(R.layout.list_item,null,true);
